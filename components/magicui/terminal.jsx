...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-white/10 bg-black/50 backdrop-blur-md z-0 h-full max-h-100 w-full max-w-lg rounded-xl border shadow-xl text-white mx-auto",
        className
      )}
    >
      ...
      <pre className="p-4">
        <code className="grid gap-y-1 overflow-auto font-mono text-left">{wrappedChildren}</code>
      </pre>
    </div>
  )
