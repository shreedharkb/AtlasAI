...
export const ATLAS_AI_LOGO_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 100" width="340" height="100"><text x="5" y="82" font-family="system-ui, -apple-system, sans-serif" font-weight="900" font-size="96" letter-spacing="-3.5" fill="%23000000">AtlasAI</text></svg>`;
